...
export default function Hero() {
    return (
        ...
        <div className="max-w-4xl mx-auto text-center">
            <img src={hcmutLogo} alt="HCMUT Logo" className="mx-auto mb-6 w-40 h-40" />
            <h1 className="text-4xl sm:text-4xl uppercase font-bold bg-gradient-to-r from-[#4FC3F7] to-[#484E53] bg-clip-text text-transparent mb-2">Bài tập lớn 1</h1>
            <h1 className="text-4xl sm:text-4xl font-bold leading-tight mb-4 text-[#484E53] capitalize">
            Classification
            </h1>
            <p className="text-lg text-slate-600 mb-1">Giảng viên hướng dẫn: TS. Lê Thành Sách</p>

            <p className="text-lg text-slate-600 mb-6">Nhóm: <strong>ABC1</strong></p>
            <div className="mt-6">
