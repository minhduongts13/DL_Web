...
const ImageDemo = () => {
    ...
    return (
        <div className="max-w-4xl mx-auto bg-white rounded-[20px] p-6 sm:p-8 shadow-sm border border-slate-100 mt-8">
            <div className="mb-8">
                ...
                <p className="text-slate-500 mt-2">Upload an image to see how our Convolutional Neural Networks and Vision Transformers perform in real-time.</p>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
                ...
                <div className="space-y-6">
                    {/* Khu vực Upload Ảnh */}
                    <div>
                        <label className="block text-sm font-semibold text-slate-700 mb-2">1. Input Image</label>
                    ...
                    {/* Khu vực Chọn Model */}
                    <div>
                        <label className="block text-sm font-semibold text-slate-700 mb-2">2. Select Architecture</label>
